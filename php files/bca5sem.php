...
<body>
    ...
    <a href="http://localhost/project/php files/web.php" class="btn btn-primary sem">Web development</a>
    <a href="http://localhost/project/php files/mis.php" class="btn btn-info sem">Management Information System</a>
    <a href="http://localhost/project/php files/cg.php" class="btn btn-success sem">Computer Graphics</a>
    <a href="http://localhost/project/php files/iot.php" class="btn btn-danger sem">Internet Of Things</a>
