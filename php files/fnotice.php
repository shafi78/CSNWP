...
<div class="home">
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        ...
        <div class="regs">
        <h1 class="form-reg">Upload Notice</h1>
         </div>
            <form class="form-box" action="fviewnotice.php" method="post" enctype="multipart/form-data">
                <label>Upload File :</label><input type="file" name="myfile" class="input-field profile" placeholder="" required>
                <br><br>
