...
<div class="home">
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        ...
        <div class="regs">
        <h1 class="form-reg">Upload I-A Marks</h1>
         </div>
            <form class="form-box" action="" method="post" enctype="multipart/form-data">
                <label>Course :</label><input type="text" name="course" class="input-field course" required><br><br>
                <label>Semister :</label><input type="text" name="title" class="input-field title" required><br><br>
                <label>IA :</label><input type="text" name="ia" class="input-field ia" required><br><br>
                ...
                <a href="http://localhost/project/php files/iamarksview.php" class="btn btn-primary view">View</a>
...
if (isset($_POST['submit']))
       {
        ...
        $insertquery = "INSERT into iamarks(course,title,ia,file) values ('$course','$title','$ia','$webfile')" ;
        ...
        if ($res && !(empty($webfile)) && !(empty($title)) )
        {
           ...
           <script>
                ...
                location.replace("iamarksview.php");
            </script>
