...
<!-- updating admins in aupdateprofile.php -->

<label>Name : </label><input type="text" name="aname"class="input-field name" placeholder="" value="<?php echo $arrdata['Name']; ?>" >
<br><br>
<label>Admin Id : </label><input type="text" name="aid" class="input-field reg" placeholder=""  readonly="readonly" value="<?php echo $arrdata['Aid']; ?> "  >
<br><br>
...
if(isset($_POST['submit']))
{
    ...
    if ($res)
    {
       ...
       <script>
            ...
            location.replace("aviewprofile.php");
        </script>
