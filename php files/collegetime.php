...
<html lang="en">
  <head>
    ...
    <title>Collge time upload</title>
...
<div class="home">
    ...
    <nav class="navbar navbar-expand-lg bg-light">
        ...
        <div class="regs">
        <h1 class="form-reg">College Time Table</h1>
         </div>
            <form class="form-box" action="viewcollege.php" method="post" enctype="multipart/form-data">
                <label>Upload File :</label><input type="file" name="collegetime" class="input-field profile" placeholder="" required>
                <br><br>
                <button type="submit" class="submit-btn" name="submit">Upload</button>
                <a href="http://localhost/project/php files/viewcollege.php" class="btn btn-primary view">View</a>
            </form>
