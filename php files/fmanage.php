...
<div class="main-div">
    <h1 class="mang">Manage Faculty</h1>
...
<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $squery = "select * from fregister where Name Like '%$str%' or Fid Like '%$str%'" ;
        ...
        if ($row = mysqli_fetch_assoc($myquery))
        {
            ...
            <table align="center"  width="1200px" class="search-tbl">
                ...
                <tr>
                        ...
                        <td><a href="http://localhost/project/php files/fupdate.php?Fid=<?php echo $row['Fid']?>" class="btn btn-primary">Edit</a></td>
                        <td><a href="http://localhost/project/php files/fdelete.php?Fid=<?php echo $row['Fid']?>" class="btn btn-danger">Delete</a></td>
            ...
            <table align="center"  width="1500px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="http://localhost/project/php files/fupdate.php?Fid=<?php echo $rows['Fid']?>" class="btn btn-primary">Edit</a></td>
                        <td><a href="http://localhost/project/php files/fdelete.php?Fid=<?php echo $rows['Fid']?>" class="btn btn-danger">Delete</a></td>
