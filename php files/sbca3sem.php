...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <a href="http://localhost/project/php files/scpp.php" class="btn btn-primary sem">C + +</a>
    <a href="http://localhost/project/php files/sds.php" class="btn btn-info sem">Data Structures</a>
    <a href="http://localhost/project/php files/sdc.php" class="btn btn-success sem">Data Communication</a>
    <a href="http://localhost/project/php files/sos.php" class="btn btn-danger sem">Operating System</a>
