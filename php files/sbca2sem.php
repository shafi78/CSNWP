...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <a href="http://localhost/project/php files/sfodl.php" class="btn btn-primary sem">Fundamentals of Digital Logic</a>
    <a href="http://localhost/project/php files/sfoa.php" class="btn btn-info sem">Fundamentals of Algorithm</a>
    <a href="http://localhost/project/php files/snsm.php" class="btn btn-success sem">Numerical & Statistics</a>
    <a href="http://localhost/project/php files/sic.php" class="btn btn-danger sem">Indian Constitution</a>
