...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <a href="http://localhost/project/php files/sjava.php" class="btn btn-primary sem">Java</a>
    <a href="http://localhost/project/php files/sdbms.php" class="btn btn-info sem">Database Management System</a>
    <a href="http://localhost/project/php files/sse.php" class="btn btn-success sem">Software Engineering</a>
    <a href="http://localhost/project/php files/ssp.php" class="btn btn-danger sem">System Programming</a>
