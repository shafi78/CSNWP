...
<body>
   ...
   <nav class="navbar navbar-expand-lg bg-light">
      ...
      <h2 class="f1">Overview</h2>
      <p class="startpara">BCA is a new age degree course in the field of computer applications. After completion of the BCA course, students can opt for masters or they can even try for job opportunities. Bachelor of Computer Applications is a course that is customized for students wishing to shine in the field of computers and information technology. For aspirants of computer related careers, BCA is an ideal course. The course not only provides technical skills but also contributes to other personality attribute related skills required for a professional executive. The course provides an exclusive training to an individual to expose his/her acquired skills in the corporate sector.</p>


      <!-- Eligibility -->

      <h2 class="f2">Eligibility</h2>

          <p class="paragp">
            Any student who has passed PUC-II / 10+2 Science or Commerce with Mathematics / Business Mathematics / Accountancy / Computer Science with a minimum of 35% marks conducted by State Boards or 3 years.
              <br><br> Diploma with Computer Science/Information Science or 2 years JOC/ ITI with Computer Science subject shall be eligible.
              <br><br> Diploma / JOC / ITI passed students should have the passing certificate of at least one Language course from the examination conducted by NIOS / PU Board and another passing certificate of one subject from the examination conducted by any ODL/ PUC.
        </p>

        <img class="img1" src="http://localhost/project/images/bca1.JPEG" alt="image1">

        <!-- BCA @ AIISM -->

        <img src="http://localhost/project/images/bca2.JPEG" alt="image2" class="img2">

        <h2 class="f3">BCA @ AIISM</h2>
        
        <p class="paragp2">
            AIISM's approach is to develop leaders for business, focus on enhancing practical skills, increasing abilities to generate and evaluate innovate ideas and also work as a team
            <br><br>
            (*) Highly Qualified and Experienced Teaching Staff
            <br><br>
            (*) Students demonstrate critical thinking skills
            <br><br>
            (*) Students will have knowledge about global business environment and the ethical factors
            <br><br>
            (*) Students will be proficient in business analysis and presentation
        </p>

        <!-- Career Avenues -->

        <img src="http://localhost/project/images/bca3.JPEG" alt="image 3" class="img3">
        <h2 class="f4">Career Avenues</h2> 

        <p class="paragp3">
            (*) BCA graduates can get employment in different sectors like MNC's, Private Sector, Government Sector..., the choice is endless.
            <br><br>
            (*) BCA graduates are trained in skills so that they can be self employed and provide employment to society by setting up their own business.
            <br><br>
            (*) BCA graduates can get government jobs by appearing for government service examinations like IAS, KAS, KPSC and National Defence Services etc.
            <br><br>
            (*) BCA graduates can appear for banking exams and get placed in reputed nationalized and private banks.
            <br><br>
            (*) BCA lays a basic platform for students to pursue, MCA, MBA, M.Sc.(CS), M.Sc.(I.T.),MSW.
