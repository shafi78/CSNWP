...
if (isset($_POST['sname']))
{
    ...
    $sql = "SELECT * from sregister where name='$sname' AND regno='$regno' AND password='$password' limit 1" ;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light">
      ...
      <form class="form-box" action="" method="post">
                ...
                <p class="qtn">Don't have an account ? <a class="hyper" href="http://localhost/project/php files/sreg.php">Register here</a></p>
            </form>
