...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <a href="http://localhost/project/php files/sbca1sem.php" class="btn btn-primary sem">1 Semister</a>
    <a href="http://localhost/project/php files/sbca2sem.php" class="btn btn-primary sem">2 Semister</a>
    <a href="http://localhost/project/php files/sbca5sem.php" class="btn btn-success sem">5 Semister</a>
    <a href="http://localhost/project/php files/sbca6sem.php" class="btn btn-success sem">6 Semister</a>
    <a href="http://localhost/project/php files/sbca3sem.php" class="btn btn-success sem">3 Semister</a>
    <a href="http://localhost/project/php files/sbca4sem.php" class="btn btn-success sem">4 Semister</a>
    <a href="http://localhost/project/php files/sbca7sem.php" class="btn btn-danger sem">7 Semister</a>
    <a href="http://localhost/project/php files/sbca8sem.php" class="btn btn-danger sem">8 Semister</a>
