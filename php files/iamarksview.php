...
<div class="main-div">
    <h1 class="mang">View I-A Marks</h1>
                ...
                while ($rows = mysqli_fetch_assoc($result))
                    {
                        ...
                        <tr>
                            ...
                            <td><a href="http://localhost/project/php files/iamarksdelete.php?Aid=<?php echo $rows['id'];?>" class="btn btn-primary">Delete</a></td>
                <?php
                    } 
                ?>
