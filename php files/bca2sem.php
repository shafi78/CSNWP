...
<body>
    ...
    <a href="http://localhost/project/php files/fodl.php" class="btn btn-primary sem">Fundamentals of digital logic</a>
    <a href="http://localhost/project/php files/foa.php" class="btn btn-info sem">Fundamentals of Algorithm</a>
    <a href="http://localhost/project/php files/nsm.php" class="btn btn-success sem">Numerical & Statistics</a>
    <a href="http://localhost/project/php files/ic.php" class="btn btn-danger sem">Indian Constitution</a>
