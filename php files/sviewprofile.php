...
<?php
$user = $_SESSION['email'];
$query = "select * from sregister  where regno = '$user'" ;
...
<p style="text-align:center;color:blue;font-size:30px;text-transform:capitalize;font-family:'Times New Roman', Times, serif"><label style="font-size:25px;color: darkred;font-weight:500;font-family:system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">Faculty ID : </label> <?php echo $rows['Regno'];?></p>
<p style="margin:20px 0px 0px 50px">
<a style="margin:20px 0px 0px 50px;font-size:15px;" href="http://localhost/project/php files/shome.php" class="btn btn-danger">Back</a>
<a style="margin:20px 0px 0px 150px;font-size:15px;" href="http://localhost/project/php files/supdateprofile.php?Regno=<?php echo $rows['Regno']?>" class="btn btn-primary">Update</a></p>
