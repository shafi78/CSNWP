...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <a href="http://localhost/project/php files/sbba1sem.php" class="btn btn-primary sem">1 Semister</a>
    <a href="http://localhost/project/php files/sbba2sem.php" class="btn btn-primary sem">2 Semister</a>
    <a href="http://localhost/project/php files/sbba5sem.php" class="btn btn-success sem">5 Semister</a>
    <a href="http://localhost/project/php files/sbba6sem.php" class="btn btn-success sem">6 Semister</a>
    <a href="http://localhost/project/php files/sbba3sem.php" class="btn btn-success sem">3 Semister</a>
    <a href="http://localhost/project/php files/sbba4sem.php" class="btn btn-success sem">4 Semister</a>
    <a href="http://localhost/project/php files/sbba7sem.php" class="btn btn-danger sem">7 Semister</a>
    <a href="http://localhost/project/php files/sbba8sem.php" class="btn btn-danger sem">8 Semister</a>
