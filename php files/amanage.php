...
<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $squery = "select * from aregister where Name Like '%$str%' or Aid Like '%$str%'" ;
        ...
        if ($row = mysqli_fetch_assoc($myquery))
        {
            ...
            <table align="center"  width="1200px" class="search-tbl">
                ...
                <tr>
                        ...
                        <td><a href="http://localhost/project/php files/aupdate.php?Aid=<?php echo $row['Aid']?>" class="btn btn-primary">Edit</a></td>
                        <td><a href="http://localhost/project/php files/adelete.php?Aid=<?php echo $row['Aid']?>" class="btn btn-danger">Delete</a></td>
            ...
            <table align="center"  width="1500px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="http://localhost/project/php files/aupdate.php?Aid=<?php echo $rows['Aid']?>" class="btn btn-primary">Edit</a></td>
                        <td><a href="http://localhost/project/php files/adelete.php?Aid=<?php echo $rows['Aid']?>" class="btn btn-danger">Delete</a></td>
