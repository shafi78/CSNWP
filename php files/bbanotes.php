...
<body>
    ...
    <a href="http://localhost/project/php files/bca1sem.php" class="btn btn-primary sem">1 Semister</a>
    <a href="http://localhost/project/php files/bca2sem.php" class="btn btn-primary sem">2 Semister</a>
    <a href="http://localhost/project/php files/bca5sem.php" class="btn btn-success sem">5 Semister</a>
    <a href="http://localhost/project/php files/bca6sem.php" class="btn btn-success sem">6 Semister</a>
    <a href="http://localhost/project/php files/bca3sem.php" class="btn btn-success sem">3 Semister</a>
    <a href="http://localhost/project/php files/bca4sem.php" class="btn btn-success sem">4 Semister</a>
    <a href="http://localhost/project/php files/bca7sem.php" class="btn btn-danger sem">7 Semister</a>
    <a href="http://localhost/project/php files/bca8sem.php" class="btn btn-danger sem">8 Semister</a>
