...
{
  ?>
  <h1 class="nul">No Posts Found</h1>
  <?php
}
...
<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $squery = "select * from posts where user_id Like '%$str%' or user_name Like '%$str%' or post_text Like '%$str%' or created_at Like '%$str%'" ;
        ...
        if ($row = mysqli_fetch_assoc($myquery))
        {
            ...
            <tr> 
                    ...
                    <tr>
                        ...
                        <td class="capital"><?php echo $row['user_name']; ?></td>
                        <td>
                        <?php 
                        ...
                        {
                            ?>
                            <img src="upload/<?php echo $row['post_img']?>" alt="File" height="80" width="80" class="mypost">
                            <?php
                        }
                        ?></td>
                        <td>
                        ...
                        <td><a href="http://localhost/project/php files/postdelete.php?id=<?php echo $row['id']?>" class="btn btn-danger">Delete</a></td>
            ...
            <table align="center"  width="1500px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="capital"><?php echo $rows['user_name']; ?></td>
                        <td>
                        <?php 
                        if (empty($rows['post_img']))
                        {
                            ?>
                            <p style="color: red;">No Image</p>
                        <?php 
                        ...
                        {
                            ?>
                            <img src="upload/<?php echo $rows['post_img']?>" alt="File" height="80" width="80" class="mypost">
                            <?php
                        }
                        ?></td>
                        <td>
                        <?php 
                        if (empty($rows['post_text']))
                        {
                            ?>
                            <p style="color: red;">No Text</p>
                        <?php 
                        ...
                        <td><a href="http://localhost/project/php files/postdelete.php?id=<?php echo $rows['id']?>" class="btn btn-danger">Delete</a></td>
