...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <a href="http://localhost/project/php files/scccp.php" class="btn btn-primary sem">C Programming</a>
    <a href="http://localhost/project/php files/slinux.php" class="btn btn-info sem">Linux</a>
    <a href="http://localhost/project/php files/smaths.php" class="btn btn-success sem">Mathematics</a>
    <a href="http://localhost/project/php files/sevs.php" class="btn btn-danger sem">Environmental Science</a>
    <a href="http://localhost/project/php files/senglish1.php" class="btn btn-primary sem">English</a>
    <a href="http://localhost/project/php files/skannada1.php" class="btn btn-success sem">Kannada</a>
