...
?>
                ...
                <label>Name : </label><input type="text" name="fname"class="input-field name" placeholder="" value="<?php echo $arrdata['Name']; ?>" required>
                <br><br>
                <label>Faculty Id : </label><input type="text" name="fid" class="input-field reg" placeholder="" value="<?php echo $arrdata['Fid']; ?>" required>
                <br><br>
                <label>Email : </label><input type="email" name="email" class="input-field email" placeholder="" value="<?php echo $arrdata['Email']; ?>" required>
                <br><br>
                <label>Password :</label><input type="password" name="password" class="input-field password" placeholder="" value="<?php echo $arrdata['Password']; ?>" required>
                <br><br>
                <label>Profile :</label>
