...
<body>
    ...
    <a href="http://localhost/project/php files/cpp.php" class="btn btn-primary sem">C + +</a>
    <a href="http://localhost/project/php files/ds.php" class="btn btn-info sem">Data Structures</a>
    <a href="http://localhost/project/php files/dc.php" class="btn btn-success sem">Data Communication</a>
    <a href="http://localhost/project/php files/os.php" class="btn btn-danger sem">Operating System</a>
