...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <a href="http://localhost/project/php files/sweb.php" class="btn btn-primary sem">Web development</a>
    <a href="http://localhost/project/php files/smis.php" class="btn btn-info sem">Management Information System</a>
    <a href="http://localhost/project/php files/scg.php" class="btn btn-success sem">Computer Graphics</a>
    <a href="http://localhost/project/php files/siot.php" class="btn btn-danger sem">Internet Of Things</a>
