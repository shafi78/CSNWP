...
<body>
    ...
    <a href="http://localhost/project/php files/java.php" class="btn btn-primary sem">Java</a>
    <a href="http://localhost/project/php files/dbms.php" class="btn btn-info sem">Database Management System</a>
    <a href="http://localhost/project/php files/se.php" class="btn btn-success sem">Software Engineering</a>
    <a href="http://localhost/project/php files/sp.php" class="btn btn-danger sem">System Programming</a>
